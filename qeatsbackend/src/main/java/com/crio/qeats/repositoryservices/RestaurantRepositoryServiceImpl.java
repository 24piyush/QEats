...
public class RestaurantRepositoryServiceImpl implements RestaurantRepositoryService {
  ...
  public List<Restaurant> findAllRestaurantsCloseBy(Double latitude,
      Double longitude, LocalTime currentTime, Double servingRadiusInKms) {
        ...
        List<Restaurant> resturantsOpenAndCloseBy = new ArrayList<>();
        ...
        for (RestaurantEntity restaurantEntity : restaurantEntitiesList) {
          if(isRestaurantCloseByAndOpen(restaurantEntity,currentTime,latitude,longitude,servingRadiusInKms)) {
            resturantsOpenAndCloseBy.add(modelMapper.map(restaurantEntity,Restaurant.class));
          }
        }

        return resturantsOpenAndCloseBy;
      //CHECKSTYLE:OFF
      //CHECKSTYLE:ON
  }
