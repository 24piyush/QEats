...
class RestaurantServiceTest {
  ...
  private String getServingRadius(List<Restaurant> restaurants, LocalTime timeOfService) {
    ...
    if((timeOfService.isAfter(LocalTime.of(8,0)) && timeOfService.isBefore(LocalTime.of(10,0)))
      || (timeOfService.isAfter(LocalTime.of(13,0)) && timeOfService.isBefore(LocalTime.of(14,0)))
      || (timeOfService.isAfter(LocalTime.of(19,0)) && timeOfService.isBefore(LocalTime.of(21,0)))
      || ((timeOfService.equals(LocalTime.of(8, 0))) || (timeOfService.equals(LocalTime.of(10, 0)))
      || (timeOfService.equals(LocalTime.of(13, 0))) || (timeOfService.equals(LocalTime.of(14, 0)))
      || (timeOfService.equals(LocalTime.of(19, 0))) || (timeOfService.equals(LocalTime.of(21, 0))))) {
  ...
  void normalHourServingRadiusIs5Kms() throws IOException {
    ...
    assertEquals(getServingRadius(loadRestaurantsDuringNormalHours(), LocalTime.of(12, 0)), "5.0");
  }
