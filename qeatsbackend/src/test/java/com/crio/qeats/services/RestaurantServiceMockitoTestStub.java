...
public class RestaurantServiceMockitoTestStub {
  ...
  public void  testFindNearbyWithin5km() throws IOException {
    ...
    //System.out.println(this.restaurant1.toString()+this.restaurant2.toString());
     when(restaurantRepositoryServiceMock
            ...
            .thenReturn(Arrays.asList(this.restaurant1, this.restaurant2));
  ...
  public void  testFindNearbyWithin3km() throws IOException {
    ...
    List<Restaurant> restaurantList1 = Arrays.asList(this.restaurant1,this.restaurant4);
    List<Restaurant> restaurantList2 = Arrays.asList(this.restaurant2,this.restaurant4);
